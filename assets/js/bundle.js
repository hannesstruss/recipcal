...
var _processorJs2 = _interopRequireDefault(_processorJs);

var _ingredientJs = require('./ingredient.js');

var _ingredientJs2 = _interopRequireDefault(_ingredientJs);

var _viewViewJsx = require('./view/view.jsx');

var _viewViewJsx2 = _interopRequireDefault(_viewViewJsx);

(0, _viewViewJsx2['default'])();


},{"./ingredient.js":159,"./processor.js":160,"./view/view.jsx":161}],2:[function(require,module,exports){
...
var mixedFractionRe = /^(\d+)\s+(\d+)\/(\d+)\s+\w/;
var fractionRe = /^(\d+)\/(\d+)\s+\w/;
var numberRe = /^(\d+(\.(\d+))?)\s+\w/;
...
var literalRe = new RegExp('^(' + Object.keys(numbers).join('|') + ')\\s+\\w');

var units = ['cup', 'tbsp', 'tsp', 'l', 'liters', 'pinch', 'pinches', 'quart', 'tablespoon', 'teaspoon'];
var unitRe = new RegExp('^(' + units.map(function (u) {
  return u + 's?';
}).join('|') + ')\\s+');

var nameClutterRe = /^(of (an? )?)/;

var IngredientProcessor = (function () {
  ...
  _createClass(IngredientProcessor, [{
    key: 'parse',
    value: function parse(ingredients) {
      var _this = this;
      ...
      return ingredients.split('\n').filter(function (x) {
        ...
        return _this.parseIngredient(line);
      });
    }
  }, {
    key: 'parseIngredient',
    value: function parseIngredient(line) {
      var amountResult = this.parseAmount(line);
      var amount = null;
      ...
      return new _ingredientJs2['default'](amount, unit, this.sanitizeName(name));
    }
  }, {
    key: 'parseAmount',
    value: function parseAmount(line) {
      var m = mixedFractionRe.exec(line);
      if (m) {
        return new Amount(parseInt(m[1], 10) + parseInt(m[2], 10) / parseInt(m[3], 10), m.index, m[0].length);
      }

      m = fractionRe.exec(line);
      if (m) {
        return new Amount(parseInt(m[1], 10) / parseInt(m[2], 10), m.index, m[0].length);
      }
...
var Amount = function Amount(amount, start, length) {
...
},{"./ingredient.js":159}],161:[function(require,module,exports){
'use strict';
...
var _UnitSystemJs = require('../UnitSystem.js');
...
var RecipeInput = (function (_React$Component) {
  function RecipeInput(props) {
    ...
    _get(Object.getPrototypeOf(RecipeInput.prototype), 'constructor', this).call(this, props);
    this.state = {
      value: ''
  ...
  _createClass(RecipeInput, [{
    ...
    value: function componentDidMount() {
      this.props.onRecipeChanged(_react2['default'].findDOMNode(this.refs.textarea).value);
    }
  }, {
    key: 'onChange',
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        this.props.ingredients.map(function (ingredient) {
          return _react2['default'].createElement(
            'li',
            { key: ingredient.name, className: 'ingredient' },
            ingredient.amount,
            ' ',
            ingredient.unit,
            ' ',
        ...
        _react2['default'].createElement(
          'li',
          null,
          _react2['default'].createElement('input', { type: 'text', className: 'recipeInput', placeholder: 'Add another ingredient...' })
        )
      );
    }
  }]);
...
var ConverterSettings = (function (_React$Component3) {
  ...
  _createClass(ConverterSettings, [{
    ...
    value: function onUnitSystemChanged(e) {
      this.props.onUnitSystemChanged(e.target.value);
    }
  }, {
    key: 'onMultiplierChanged',
    value: function onMultiplierChanged(e) {
    ...
    value: function render() {
      return _react2['default'].createElement(
        'div',
        { className: 'recipeConverter-controls' },
        _react2['default'].createElement(
          'ul',
          null,
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              { name: 'units',
                type: 'radio',
                value: _UnitSystemJs2['default'].EUROPE,
                onChange: this.onUnitSystemChanged.bind(this),
                checked: this.props.unitSystem === _UnitSystemJs2['default'].EUROPE },
              _react2['default'].createElement(
                'label',
                null,
                'Europe'
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              { name: 'units',
                type: 'radio',
                value: _UnitSystemJs2['default'].US,
                onChange: this.onUnitSystemChanged.bind(this),
                checked: this.props.unitSystem === _UnitSystemJs2['default'].US },
              _react2['default'].createElement(
                'label',
                null,
                'U.S.'
...
var RecipeConverter = (function (_React$Component4) {
  function RecipeConverter(props) {
    ...
    _get(Object.getPrototypeOf(RecipeConverter.prototype), 'constructor', this).call(this, props);
    this.state = {
      unitSystem: _UnitSystemJs2['default'].EUROPE,
      multiplier: '1'
    };
  }
  ...
  _createClass(RecipeConverter, [{
    key: 'onUnitSystemChanged',
    value: function onUnitSystemChanged(unitSystem) {
      this.setState({
    ...
    key: 'onMultiplierChanged',
    value: function onMultiplierChanged(multiplier) {
      this.setState({
        multiplier: multiplier
      });
    }
  }, {
    key: 'getTransformedIngredients',
    value: function getTransformedIngredients() {
      var multiplier = parseFloat(this.state.multiplier.replace(',', '.'), 10);
      if (isNaN(multiplier)) {
        multiplier = 1;
      }
    ...
    value: function render() {
      return _react2['default'].createElement(
        'div',
        null,
        _react2['default'].createElement(IngredientList, { ingredients: this.getTransformedIngredients() }),
        _react2['default'].createElement(ConverterSettings, { unitSystem: this.state.unitSystem,
...
var RecipcalApp = (function (_React$Component5) {
  function RecipcalApp(props) {
    ...
    _get(Object.getPrototypeOf(RecipcalApp.prototype), 'constructor', this).call(this, props);
    this.processor = new _processorJs2['default']();
    this.state = {
      ingredients: []
    };
  }
  ...
  _createClass(RecipcalApp, [{
    key: 'onRecipeChanged',
    value: function onRecipeChanged(recipe) {
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        { className: 'app' },
        input ? _react2['default'].createElement(RecipeInput, { onRecipeChanged: this.onRecipeChanged.bind(this) }) : null,
        !input ? _react2['default'].createElement(RecipeConverter, { ingredients: this.state.ingredients }) : null
      );
    }
  }]);
...
module.exports = function () {
  _react2['default'].render(_react2['default'].createElement(RecipcalApp, null), document.querySelector('.content'));
};


},{"../UnitSystem.js":158,"../processor.js":160,"react":157}]},{},[1])
